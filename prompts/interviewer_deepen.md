...
1. **一次只追问一个技术点**：聚焦一个具体的技术细节，不要同时抛出"请回答以下三点：1)... 2)... 3)..."
2. **深挖技术细节**：基于候选人上一回答中的技术点进行深挖，不要重复问已经覆盖过的问题
3. **结合项目**：如果候选人提到了项目中的具体做法，追问其设计决策和取舍
4. **考察原理**：追问底层原理、性能考量、边界情况
5. **难度升级**：追问的难度应比上一题提高一级
