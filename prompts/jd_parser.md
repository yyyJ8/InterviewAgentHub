...
**核心开发技能**（编程语言、框架、架构、数据库等）：
- JD 反复强调、大篇幅描述：80-100
- 明确列出但未展开：60-79
- 加分/了解即可：30-59，is_bonus = true

**工具/基础设施技能**（Docker、Kubernetes、Git、Linux、CI/CD、Nginx 等）：
- 工具技能不是面试的核心考察点，权重一律不超过 50
- 即使 JD 强调，也只给 40-50
- 如果只是顺带提及，给 20-30 或放入 bonus_skills
- IDE/编辑器类（IDEA、VS Code）不给权重，不放技能列表
